...
},{"./viewport-splitter-master-controller":2}],2:[function(require,module,exports){
...
},{"./gui-controllers/all-controllers":1,"./widget-templates/all-widgets":4}],4:[function(require,module,exports){
require('./viewport-splitter');
},{"./viewport-splitter":5}],5:[function(require,module,exports){
let $ = require('jquery');
...
let isBetween = (min, max, val) => {
    return x <= val && val < max;
}

let getSquareBounds = (row, col) => {
    let numCols = rows[row].length;
    let widthP = 100 / (numCols + 0.0);

    let numRows = rows.length;

}

let getSquareBoundsAt = (parentX, parentY) => {
    // 1. Scan in x-direction, all squares
    for (row of rows) {
        for (col of row) {
...
let getBoundsOfSquareWithIndex = (index) => {

}

let getDropResultDirection = (parentX, parentY) => {
    // 1. Find out the bounds of the square it is within

    // 2. Infer the direction from that
}
